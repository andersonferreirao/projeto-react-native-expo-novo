...
const BoasVindas = ({ navigation, route }) => {
  ...
  const handleClientesAgendadosClick = () => {
    navigation.navigate('ListaClientes'); // Navegue para a tela de ListaClientes
  };
      ...
      <View style={styles.container}>
        ...
        {!nomeEstabelecimento ? (
          <Text style={styles.description}>
            Vamos começar o cadastro do seu estabelecimento? Vai levar 1 minutinho, só seu nome e CNPJ!
          </Text>
        ) : null}
        {(!nomeEstabelecimento) ? (
          <>
          ...
          <>
            ...
            <TouchableOpacity style={styles.additionalButton} onPress={handleClientesAgendadosClick}>
